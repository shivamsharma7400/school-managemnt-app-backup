...
import 'principal_complaint_screen.dart';
...
import 'strategic_planning_screen.dart';
...
class PrincipalDashboard extends StatelessWidget {
  ...
  Widget _buildMetricsGrid(BuildContext context, BoxConstraints constraints) {
    ...
    return GridView.count(
      ...
      crossAxisSpacing: 16, // Slightly reduced spacing
      mainAxisSpacing: 16,
      ...
      children: [
        ...
        GridView.count(
          ...
          children: [
            ...
            _buildModuleItem(context, 'Migration', Icons.cloud_download, Colors.blueGrey, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const DataMigrationScreen()))),
          ],
        ...
        child: Column(
          ...
          children: [
            ...
            StreamBuilder<List<Announcement>>(
              stream: announcementService.getAnnouncements('principal'),
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return const Center(
                    child: Padding(
...
class ComplaintBoxMetricCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<int>(
      stream: complaintService.getPendingComplaintsCount(),
      builder: (context, snapshot) {
